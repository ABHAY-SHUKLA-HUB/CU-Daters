...
router.get('/legal-content', asyncHandler(async (req, res) => {
  const defaults = {
    ...
    termsLastUpdated: 'March 28, 2026',
    privacyLastUpdated: 'March 2026',
    legalEmail: 'info@cudaters.tech',
    privacyEmail: 'privacy@cudaters.tech',
    supportEmail: 'support@cudaters.tech',
    disputeResponseDays: '7',
    arbitrationCity: 'Mohali, Punjab, India',
    governingLaw: 'Laws of India',
    mailingAddress: 'SeeU Daters, NH-05 Chandigarh-Ludhiana Highway in Gharuan, Mohali, Punjab (PIN: 140413), India',
    termsBlocks: [
      {
        title: 'Eligibility',
